...
namespace XRL.Language
{
    public static class Grammar
    {
        ...
        public static string MakeOrList(IReadOnlyList<string> Words, bool Serial = true)
        {
            if (Words.Count == 0)
            {
                return "";
        ...
        {
            return Translator.MakeAndList(Words, new(Serial));
        }
        ...
        private static bool IsArticleException(string Word)
        {
            ...
            {
                if( string.Compare(Word, articleExceptions[x], StringComparison.OrdinalIgnoreCase) == 0 ) return true;
            }
            return false;
        }
